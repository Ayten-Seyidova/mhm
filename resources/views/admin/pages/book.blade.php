                                ...
                                <table id="example3" class="display min-w850">
                                    ...
                                    @foreach($posts as $key => $postItem)
                                        <tr id="row{{$postItem->id}}" class="text-center">
                                            ...
                                            <td>
                                                <img class="d-block" style="width: 100px; margin: auto"
                                                     src="{{asset($postItem->image)}}" alt="">
                                            </td>
                                            <td>{{$postItem->title}}</td>
                                            <td>{{$postItem->teacher_name}}</td>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form id="formCreate" action="{{route('book.store')}}" method="POST"
                    ...
                    <div class="modal-body pb-0 pt-2">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div class="form-group video-section">
                                    <label for="name">Müəllim</label>
                                    <input class="form-control" value="{{old('teacher_name')}}"
                                           type="text" maxlength="190" required
                                           name="teacher_name" id="name"/>
                                </div>
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{old('price')}}"
                                           type="number" step="0.01" maxlength="190"
                                           name="price" id="price"/>
                                </div>
                                <div class="form-group">
                                    <label for="editor">Məzmun</label>
                    ...
                    <div class="modal-body pb-0 pt-2">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div class="form-group video-section">
                                    <label for="nameEdit">Müəllim</label>
                                    <input class="form-control"
                                           type="text" maxlength="190" required
                                           name="teacher_name" id="nameEdit"/>
                                </div>
                                <div class="form-group d-flex mt-4">
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    <label for="priceEdit">Qiymət</label>
                                    <input class="form-control"
                                           type="number" step="0.01" maxlength="190"
                                           name="price" id="priceEdit"/>
                                </div>
                                <div class="form-group">
                                    <label for="editorEdit">Məzmun</label>
                                    <textarea name="description" class="editorEdit"
                                              id="editorEdit" cols="30"
                                              rows="10">{{old('description')}}</textarea>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('.deleteItem').click(function () {
                ...
                let route = '{{route('book.destroy', ['book'=>'id'])}}';
            ...
            function editUser(dataID) {
                ...
                let route = '{{route('book.edit', ['book'=>'edit'])}}';
                route = route.replace('edit', dataID);
                let routeUpdate = '{{route('book.update', ['book' => 'update'])}}';
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        nameEdit.val(post.teacher_name);
            ...
            if (searchParams.has('book_id')) {
                let dataId = searchParams.get('book_id');
