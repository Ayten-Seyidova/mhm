    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="formCreate" action="{{route('faq.store')}}" method="POST"
                ...
                <form id="formEdit" action="" method="POST"
                    ...
                    <div class="modal-body pb-0 pt-2">
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea name="content" class="editorEdit"
    ...
    <script>
        ...
        $(function () {
            ...
            $('.deleteItem').click(function () {
                ...
                let route = '{{route('faq.destroy', ['faq'=>'id'])}}';
            ...
            function editUser(dataID) {
                ...
                let route = '{{route('faq.edit', ['faq'=>'edit'])}}';
                route = route.replace('edit', dataID);
                let routeUpdate = '{{route('faq.update', ['faq' => 'update'])}}';
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        CKEDITOR.instances['editorEdit'].setData(post.content);
                    }
                })
            }

            let searchParams = new URLSearchParams(window.location.search)
            if (searchParams.has('faq_id')) {
                let dataId = searchParams.get('faq_id');
