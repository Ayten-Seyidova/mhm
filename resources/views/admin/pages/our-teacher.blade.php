                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Müəllimlərimiz</h4>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form id="formCreate" action="{{route('our-teacher.store')}}" method="POST"
                ...
                <form id="formEdit" action="" method="POST"
                    ...
                    <div class="modal-body pb-0 pt-2">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="form-group video-section">
                                    <label for="subjectEdit">Fənn</label>
                                    <input class="form-control"
                                           type="text" maxlength="190"
                                           name="subject" id="subjectEdit"/>
                                </div>
                                <div class="form-group video-section">
                                    <label for="linkEdit">Video linki</label>
                                    <input class="form-control"
                                           type="text" maxlength="190"
        ...
        $(function () {
            ...
            $('.checkedBtn').click(function () {
                if (checkedArr.length != 0) {
                    let route = '{{route('our-teacher.checked')}}';
            ...
            $('.deleteItem').click(function () {
                ...
                let route = '{{route('our-teacher.destroy', ['our_teacher'=>'id'])}}';
            ...
            $('.changeStatus').click(function () {
                let dataID = $(this).data('id');
                $.ajax({
                    url: '{{route('our-teacher.changeStatus')}}',
                    method: 'POST',
                    data: {
                        id: dataID
                    },
            ...
            function editUser(dataID) {
                ...
                let route = '{{route('our-teacher.edit', ['our_teacher'=>'edit'])}}';
                route = route.replace('edit', dataID);
                let routeUpdate = '{{route('our-teacher.update', ['our_teacher' => 'update'])}}';
            ...
            if (searchParams.has('our-teacher_id')) {
                let dataId = searchParams.get('our-teacher_id');
