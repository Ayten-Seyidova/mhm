                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Ödənişli dərslər</h4>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form id="formCreate" action="{{route('lesson.store')}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="form-control"
                                              id="contentEdit" cols="30" required
                                              rows="10"></textarea>
                                </div>
                            </div>
                        </div>
        ...
        $(function () {
            ...
            $('.checkedBtn').click(function () {
                ...
                if (checkedArr.length != 0) {
                    let route = '{{route('lesson.checked')}}';
            ...
            $('.deleteItem').click(function () {
                ...
                let route = '{{route('lesson.destroy', ['lesson'=>'id'])}}';
            ...
            function editUser(dataID) {
                ...
                let route = '{{route('lesson.edit', ['lesson'=>'edit'])}}';
                route = route.replace('edit', dataID);
                let routeUpdate = '{{route('lesson.update', ['lesson' => 'update'])}}';
            ...
            if (searchParams.has('lesson_id')) {
                let dataId = searchParams.get('lesson_id');
