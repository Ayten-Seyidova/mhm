                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="get" id="searchForm" class="row justify-content-center" action="">
                                <input type="hidden" name="guest_exam_id" value="{{$exam->id}}">
                                ...
                                <div class="input-group col-4">
                                    <div class="form-item">
                                        <input id="search-input"
                                               ...
                                               type="search"
                                               placeholder="Axtarış et" class="form-control search-select"
                                ...
                                @if(isset($_GET['is_deleted']) && $_GET['is_deleted'] == 1)
                                    <div class="col-1">
                                        <a href="{{route('guest-question.index', ['guest_exam_id'=>$exam->id])}}"
                                ...
                                @else
                                    <div class="col-1">
                                        <a href="{{route('guest-question.index', ['is_deleted'=>1, 'guest_exam_id'=>$exam->id])}}"
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form id="formCreate" action="{{route('guest-question.store')}}" method="POST"
        ...
        $(function () {
            ...
            $('.checkedBtn').click(function () {
                if (checkedArr.length != 0) {
                    let route = '{{route('guest-question.checked')}}';
            ...
            $('.changeStatus').click(function () {
                ...
                $.ajax({
                    url: '{{route('guest-question.changeStatus')}}',
                    method: 'POST',
                    data: {
                        id: dataID
                    },
            ...
            $('.deleteItem').click(function () {
                let dataID = $(this).data('id');
                let route = '{{route('guest-question.destroy', ['guest_question'=>'id'])}}';
            ...
            function editUser(dataID) {
                ...
                let route = '{{route('guest-question.edit', ['guest_question'=>'edit'])}}';
                route = route.replace('edit', dataID);
                let routeUpdate = '{{route('guest-question.update', ['guest_question' => 'update'])}}';
            ...
            if (searchParams.has('guest-question_id')) {
                let dataId = searchParams.get('guest-question_id');
