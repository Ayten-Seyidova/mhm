                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="get" id="searchForm" class="row justify-content-center" action="">
                                ...
                                @else
                                    <div class="col-1">
                                        <a href="{{route('exam.index', ['is_deleted'=>1])}}"
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="formCreate" action="{{route('exam.store')}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    ...
                                    <select name="group_ids[]" required multiple class="form-control search-select"
                                            id="groupIds">
                                        @if(!empty($groups[0]))
                                            @foreach($groups as $group)
                    ...
                    <div class="modal-body pb-0 pt-2">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    <label for="linkEdit">Video</label>
                                    <input class="form-control"
                                           type="text" maxlength="190"
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    ...
                                    <select name="group_ids[]" multiple class="form-control search-select"
                                            id="groupIdsEdit">
                                        @if(!empty($groups[0]))
                                            @foreach($groups as $group)
    ...
    <script>
        ...
        $(function () {
            ...
            $('.deleteItem').click(function () {
                let dataID = $(this).data('id');
                let route = '{{route('exam.destroy', ['exam'=>'delete'])}}';
            ...
            function editUser(dataID) {
                ...
                let route = '{{route('exam.edit', ['exam'=>'edit'])}}';
                route = route.replace('edit', dataID);
                let routeUpdate = '{{route('exam.update', ['exam' => 'update'])}}';
            ...
            if (searchParams.has('exam_id')) {
                let dataId = searchParams.get('exam_id');
